 ...
 */
@CrossOrigin(origins = "*", maxAge = 3600) //允许所有域名访问，最大缓存时间3600
@RestController//rest api控制器，返回json数据
@RequestMapping("/auth")//根目录“/auth”
public class AuthController {

    private final AuthService authService;//构造器注入依赖，final不可变
